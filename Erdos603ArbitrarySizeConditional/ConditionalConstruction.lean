...
This file formalizes the arbitrary-size-family construction from Przemek
Chojecki's PDF discussion of Erdős Problem 603, conditional on the relevant
partition-relation input.
